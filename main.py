...
min_dict = {time_list[0]: 1000, time_list[1]: 2000, time_list[2]: 3000, time_list[3]: 5000, time_list[4]: 8000, time_list[5]: 10000, time_list[6]: 15000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 2999, time_list[1]: 3999, time_list[2]: 4999, time_list[3]: 7999, time_list[4]: 9999, time_list[5]: 14999, time_list[6]: 23000}
# 设置结束
