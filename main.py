...
min_dict = {time_list[0]: 300, time_list[1]: 500, time_list[2]: 1000, time_list[3]: 2000, time_list[4]: 3000, time_list[5]: 4000, time_list[6]: 5000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 2999, time_list[1]: 3999, time_list[2]: 3899, time_list[3]: 4899, time_list[4]: 5899, time_list[5]: 5999, time_list[6]: 6000}
# 设置结束
